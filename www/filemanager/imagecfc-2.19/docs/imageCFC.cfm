...
<A name="tempDirectory"></A>
<tr>
	<td>tempDirectory</td>
	<td>string</td>
	<td>private</td>
	<td>""</td>
	<td>Directory ImageCFC will use for working.  If this is an empty string, imageCFC will create temporary files in the destination folder.  You might consider setting this to whatever value is returned by getTempDirectory() on your system.</td>
</tr>
</table>
